    ...
    def forward(
        ...
        **kwargs,
        ...
        if dna_tokenized is not None and batch_idx_map:
            ...
            n_dna_features = sum(r.shape[0] for r in batch_dna_embeds)

            #print("n_dna_tokens:", n_dna_tokens, "n_dna_features:", n_dna_features)
            #if n_dna_features != n_dna_tokens: breakpoint()
